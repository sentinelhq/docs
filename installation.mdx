...
<Steps>
  <Step title="Add your domain">
    ...
    Go ahead and add the domain name of the website you want to run refix on, without the protocol.
     ...
     <Info>
      Note - Subdomains ( test.com and new.test.com  ) are considered as separate entities and will count in your site allowance. Checkout how many domains are allowed in each plan here
     </Info>
